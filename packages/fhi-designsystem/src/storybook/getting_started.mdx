...
Dokumentasjon for det gamle designsystemet med komponenter for Angular, samt tilhørende CSS-bibliotek, <a href="https://old.designsystem.fhi.no" target="_blank" rel="noopener" style= " color: #222; text-decoration: underline;">finner du på de gamle sidene</a>.
</div>
