...
export const FhiIconCircleCheckSelector = "fhi-icon-circle-check";

@customElement(FhiIconCircleCheckSelector)
export class FhiIconCircleCheck extends LitElement {
